...
atlas_username = 'aakash'
atlas_password = 'aakashguvi'
atlas_cluster = 'cluster0'
client = MongoClient(
    f"mongodb+srv://{atlas_username}:{atlas_password}@{atlas_cluster}.um65tbq.mongodb.net/?retryWrites=true&w=majority")
# mongodb+srv://aakash:<password>@cluster0.um65tbq.mongodb.net/?retryWrites=true&w=majority
db = client['youtube_data']
collection = db['channel_data']
# api_key
Api_key = 'AIzaSyBfymVBcjUIqLy8ST63wX5p6U1FkmKri80'
